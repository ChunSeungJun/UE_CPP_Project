...
#ifdef UE_PROJECT_PlayerAnim_generated_h
...
public: \
	DECLARE_CLASS(UPlayerAnim, UAnimInstance, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/UE_Project"), NO_API) \
...
template<> UE_PROJECT_API UClass* StaticClass<class UPlayerAnim>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID UE_Project_Source_UE_Project_Player_PlayerAnim_h
